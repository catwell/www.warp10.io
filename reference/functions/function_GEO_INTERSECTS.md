---
title: "GEO.INTERSECTS"
layout: "function"
isPage: "true"
link: "/warpscript/functions"
desc: "Checks if a Geo Time Series has at least one point within a shape."
categoryTree: ["reference","functions"]
category: "reference"
---

Checks if a Geo Time Series has at least one point within a shape.

The `GEO.INTERSECTS` function expects the following parameters on the stack:

      1: [ Geo Time Series ]
    TOP: Geo Shape

It will produce a boolean or a list of booleans indicating whether or not the Geo Time Series has at least one point within the shape.
