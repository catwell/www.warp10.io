...
<div class="right margin-left">
  <a href='https://dl.bintray.com/cityzendata/generic/io/warp10/warp10/1.2.19/warp10-1.2.21.tar.gz' target="_blank">
    <img class="no-zoom" src="{{ site.baseurl}}/img/getting-started/bintray.png" alt="Using Warp 10 Init script">
    <br />
    <img class="no-zoom" src='https://api.bintray.com/packages/cityzendata/generic/warp10/images/download.svg?version=1.2.21'>
  </a>
</div>
